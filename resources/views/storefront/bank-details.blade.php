...
@section('content')
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    @if ($order->payment_status === 'proof_submitted')
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center space-y-4">
                            ...
                            <p class="text-sm text-gray-600 max-w-md mx-auto">
                                We have received your payment receipt. Our team is verifying the transaction. This usually takes 1–2
                                hours.
                            </p>
                                ...
                                @else
                                    <div class="mt-2">
                                        ...
                                        <div class="max-w-[200px] mx-auto border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                                            <img src="{{ asset('storage/' . $order->latestProof->screenshot_path) }}" alt="Payment proof"
                    ...
                    @else
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">No payment gateway is integrated. Please pay manually using one of
                                    the methods below.</p>
                            </div>
                        </div>
                        ...
                        <div id="content-qr" class="hidden text-center py-8">
                            ...
                            <p class="text-xs text-gray-500 mt-1 max-w-xs mx-auto">Use Easypaisa, JazzCash, or any Pakistani banking
                            ...
                            <div class="flex items-center justify-between gap-4 p-4 bg-slate-50 border border-gray-100 rounded-xl">
                                <div class="flex items-center gap-4 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="font-bold text-[#0a1f44] font-mono text-sm break-all">{{  $bank['account_no'] }}
                                        </p>
                                    </div>
                                </div>
                                <button id="copy-iban"
                        ...
                        <div
                            ...
                            <span>After completing the payment using the details above, please continue to the next step to confirm
                                your payment.</span>
                        </div>
                ...
                @else
                    ...
                    <form action="{{ route('checkout.update', ['order' => $order->order_number]) }}" method="post"
                        ...
                        <label
                            ...
                            <div class="flex items-start gap-2 sm:gap-4">
                                <input type="radio" name="pay" value="bank_transfer" class="mt-1 w-4 h-4 sm:w-5 sm:h-5">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div class="relative">
                            ...
                            <span
                                class="absolute -top-2 -right-3 bg-amber-500 text-white text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center">{{ count($order->items) }}</span>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex justify-between gap-2">
                                    ...
                                    <span class="text-sm font-bold text-[#0a1f44] whitespace-nowrap">PKR
        ...
        : 'Free Shipping' }}
                ...
                <div
                    class="mt-4 bg-blue-50 border border-blue-100 rounded-lg p-3 text-xs text-gray-500 flex items-start gap-2">
                    <i class="fa-solid fa-shield-halved text-[#0a1f44] mt-0.5 shrink-0"></i>
                    <span>Your payment is secure. After manual payment, you will proceed to the Payment Confirmation
                        step.</span>
                </div>
