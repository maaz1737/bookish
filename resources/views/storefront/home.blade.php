                        ...
                        <div class="swiper-slide">
                            <div class="grid md:grid-cols-2 gap-8 items-center xs:p-4 sm:p-8 md:p-12">
                                <div class="z-10">
                                    ...
                                    <div class="hidden md:flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 mt-6 w-full">
                                    ...
                                    {{-- Hero Bottom Trust Strip for Desktop Only --}}
                                    <div class="hidden md:flex flex-wrap gap-x-6 gap-y-2 mt-10 text-xs md:text-sm text-slate-700">
                                ...
                                {{-- Image Column --}}
                                <div class="flex flex-col justify-center md:justify-end w-full">
                                    <div class="w-full max-w-[480px] aspect-[5/4] flex items-center justify-center p-4 mx-auto md:mx-0">
                                    ...
                                    {{-- Buttons for Mobile Only (Image ke bilkul neeche) --}}
                                    <div class="flex md:hidden flex-col gap-3 mt-6 w-full px-4">
                                        <a href="{{ route('schools.index') }}"
                                            class="inline-flex items-center justify-center whitespace-nowrap 
                                            w-full px-4 py-2.5 text-sm rounded-lg
                                            bg-navy-800 text-white shadow-md hover:shadow-lg
                                            transition-all duration-200 hover:bg-[#223a8f]">
                                            Shop by School <i class="fa-solid fa-arrow-right ml-1.5 text-xs"></i>
                                        </a>

                                        <a href="{{ route('categories.index') }}"
                                            class="inline-flex items-center justify-center whitespace-nowrap
                                            w-full border-2 border-[#001F54] text-[#001F54]
                                            hover:bg-[#001F54] hover:text-white
                                            px-4 py-2.5 text-sm rounded-lg font-semibold
                                            transition-all duration-200">
                                            Browse All Categories
                                    ...
                                    {{-- Trust Strip for Mobile Only (Buttons ke bhi neeche) --}}
                                    <div class="flex md:hidden justify-between items-center gap-2 mt-8 text-[11px] text-slate-700 px-2">
                                        <div class="flex flex-col items-center text-center gap-1 flex-1">
                                            <i class="fa-solid fa-shield-halved text-[#001F54] text-sm"></i>
                                            <span><b>100% Original</b></span>
                                        </div>
                                        <div class="flex flex-col items-center text-center gap-1 flex-1 border-l border-slate-200">
                                            <i class="fa-solid fa-truck text-[#001F54] text-sm"></i>
                                            <span><b>Fast Delivery</b></span>
                                        </div>
                                        <div class="flex flex-col items-center text-center gap-1 flex-1 border-l border-slate-200">
                                            <i class="fa-solid fa-rotate-left text-[#001F54] text-sm"></i>
                                            <span><b>Easy Returns</b></span>
                                        </div>
                                        <div class="flex flex-col items-center text-center gap-1 flex-1 border-l border-slate-200">
                                            <i class="fa-solid fa-lock text-[#001F54] text-sm"></i>
                                            <span><b>Secure Payments</b></span>
                                        </div>
                                    </div>
                                </div>
                ...
                @foreach ($bundles as $bundle)
                    ...
                    <div class="relative bundle-card card product-card filter-card">
                        ...
                        <div class="relative image-container">
                            ...
                            @else
                                <div class="grid grid-cols-2 grid-rows-2 h-full">
                                    @foreach ($prodImages as $prod)
                                        <div class="flex items-center justify-center p-3 border-white/60 {{ $loop->index === 0 ? 'border-r border-b' : '' }} {{ $loop->index === 1 ? 'border-b' : '' }} {{ $loop->index === 2 ? 'border-r' : '' }}">
                                            <img src="{{ $imgSrc($prod->images[0]) }}"
                                                class="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform duration-500"
                                                alt="{{ $prod->name }}" loading="lazy" />
                                        </div>
                        ...
                        <div class="product-info">
                            <div>
                                <h3 class="text-[18px] lg:text-[20px]  font-bold text-[#0a1a3d] hover:text-[#1e3a8a] transition-colors leading-snug line-clamp-2 filter-name h-8 py-6">
                                    {{ ucfirst($bundle->name) }}
                                </h3>
