...
<body class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
    ...
    <div class="w-full max-w-4xl rounded-2xl bg-white p-8 shadow-lg sm:p-12">
        ...
        <!-- Content grid -->
        <div class="mt-10 grid grid-cols-1 items-center gap-8 md:grid-cols-2">
            <!-- Illustration -->
            ...
            <div class="space-y-4 rounded-xl border border-gray-200 p-5">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="text-sm text-gray-900">BB-2024-06789</span>
                </div>
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="text-sm font-semibold text-gray-900">PKR 6,350</span>
                </div>
