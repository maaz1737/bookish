<a href="{{ route('category.show', $category->slug) }}"
    ...
    <div class="px-3 pb-4">
        <button class="primary-btn group inline-flex items-center justify-center gap-2 hover:bg-[#223a8f]">
            <span>Explore Now</span>

            <span class="inline-flex transition-transform duration-300 ease-out group-hover:translate-x-1">
