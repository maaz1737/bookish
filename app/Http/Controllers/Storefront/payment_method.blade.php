    ...
    <div class="mb-10">
        <div class="flex items-center justify-between max-w-4xl mx-auto">
            ...
            <div class="flex flex-col items-center flex-shrink-0">
                <div
                    class="w-12 h-12 rounded-full border-2 border-navy flex items-center justify-center text-navy bg-white">
                    <i class="fa-solid fa-cart-shopping"></i>
                </div>
                <span class="mt-2 text-sm font-medium text-navy">Cart</span>
            </div>
            <div class="flex-1 h-0.5 bg-navy mx-2"></div>
            <!-- Step 2 -->
            <div class="flex flex-col items-center flex-shrink-0">
                <div
                    class="w-12 h-12 rounded-full border-2 border-navy flex items-center justify-center text-navy bg-white">
                ...
                <span class="mt-2 text-sm font-medium text-navy">Checkout</span>
            </div>
            <div class="flex-1 h-0.5 bg-navy mx-2"></div>
            <!-- Step 3 active -->
            <div class="flex flex-col items-center flex-shrink-0">
                <div class="w-12 h-12 rounded-full bg-navy flex items-center justify-center text-white">
                    <i class="fa-solid fa-credit-card"></i>
                </div>
                <span class="mt-2 text-sm font-semibold text-navy">Payment</span>
            </div>
            <div class="flex-1 h-0.5 bg-navy mx-2"></div>
            <!-- Step 4 -->
            <div class="flex flex-col items-center flex-shrink-0">
                ...
                <span class="mt-2 text-sm font-medium text-navy">Confirmation</span>
            </div>
        </div>
    </div>
